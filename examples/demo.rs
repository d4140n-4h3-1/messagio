...
fn main() {
    ...
    success("✓ This message pulses twice (normal->bold during each beep)");
    error("✗ This message also pulses twice");
    warning("⚠ This message pulses twice too");
    
    println!("Messages with single beep pulse once:");
    message("Single beep test (pulses once)")
